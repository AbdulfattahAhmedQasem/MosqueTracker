...
<head>
    ...
    <title>إضافة مستخدم جديد - نظام إدارة المساجد</title>
...
<body class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
    ...
    <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-slate-800 mb-2">إضافة مستخدم جديد</h1>
            <p class="text-slate-600">أدخل بيانات المستخدم الجديد وحدد دوره في النظام</p>
        </div>
