...
<head>
    ...
    <title>تعديل الدور - نظام إدارة المساجد</title>
...
<body class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
    ...
    <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-slate-800 mb-2">تعديل الدور</h1>
            <p class="text-slate-600">تعديل بيانات الدور {{ $role->name }}</p>
        </div>
