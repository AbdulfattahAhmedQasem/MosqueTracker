...
<head>
    ...
    <title>تعديل بيانات المسجد - {{ $mosque->name }}</title>
...
<body class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 max-w-4xl mx-auto">
        <div class="mb-6">
            <h1 class="text-4xl font-bold text-slate-800 mb-2">تعديل بيانات المسجد</h1>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="مسجد" {{ old('type', $mosque->type) == 'مسجد' ? 'selected' : '' }}>مسجد</option>
                        <option value="جامع" {{ old('type', $mosque->type) == 'جامع' ? 'selected' : '' }}>جامع</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($neighborhoods as $neighborhood)
                            <option value="{{ $neighborhood->id }}" {{ old('neighborhood_id', $mosque->neighborhood_id) == $neighborhood->id ? 'selected' : '' }}>
